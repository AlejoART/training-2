...
public class SantanderResultsPage extends BasePage {
    ...
    //This one is for locating the results depending on the wantes team
    ...
    public By getTeamLocator(String teamName){
        return By.partialLinkText(teamName);
    }
    ...
    public void getPointsTeamXperWorkday(By teamLocator){
